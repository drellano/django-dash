...
from defaults import DEFAULT_SHOW_TITLE, DEFAULT_MAX_FEED_ITEMS
...
@require_POST
@login_required
def get_feed(request, layout_uid, placeholder_uid, plugin_uid, template_name='rss_reader/get_feed.html', \
             template_name_ajax='rss_reader/get_feed_ajax.html'):
    """
