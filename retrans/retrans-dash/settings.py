...
# Had to manually import different parent directory. Need more eloquent way to resolve pythonpath
sys.path.append("/home/david/Environments/dash/django-dash-stable/src")
# This directory is automatically added in Eclipse...only necessary when running manage.py in separate python shell
sys.path.append("/home/david/Environments/dash/django-dash-stable")
...
DATABASES = {
    'default': {
        ...
        'NAME': PROJECT_DIR('../db/dashboard.db'),                      # Or path to database file if using sqlite3.
