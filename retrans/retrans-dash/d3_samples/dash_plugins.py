...
plugin_widget_factory(BaseBubbleChartWidget, 'bootstrap2_fluid', 'main', \
                      'd3_bubble_chart', sizes)
plugin_widget_factory(BaseBubbleChartWidget, 'testing', 'main', \
                      'd3_bubble_chart', sizes)
...
plugin_widget_factory(BaseStackedToGroupedBarsChartWidget, 'testing', \
                      'main', 'd3_stacked_to_grouped_bars_chart', sizes)
...
plugin_widget_factory(BaseSunburstPartitionChartWidget, 'testing', \
                      'main', 'd3_sunburst_partition_chart', sizes)
